    ...
    public class SetVariable : Astral.Quester.Classes.Action
    {
        ...
        public string Variable
        {
            ...
            set
            {
                ...
                variableName = value;
                VariablesTools.Variables[variableName] = 0;
            }
        }
...
#if DEBUG
                    Astral.Logger.WriteLine(Astral.Logger.LogType.Debug, $"Variable {{{variableName}}} set to '{VariablesTools.Variables[variableName]}' ({equation.Expression})");
#endif

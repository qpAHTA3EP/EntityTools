...
{
    /// <summary>
    /// Adds sorting feature to <see cref="BindingList{T}"/>.<br/>
    /// <see href="https://referencesource.microsoft.com/#System.Data.Linq/SortableBindingList.cs"/>
    /// </summary>
    ...
    public class SortableBindingList<T> : BindingList<T>
    {
        ...
        public SortableBindingList(IList<T> list, PropertyDescriptor sortProperty,
            ListSortDirection sortDirection = ListSortDirection.Ascending) : base(list)
        {
            this.sortProperty = sortProperty;
            this.sortDirection = sortDirection;
        }

        public SortableBindingList(IList<T> list, string sortProperty,
            ListSortDirection sortDirection = ListSortDirection.Ascending) : base(list)
        {
            if (!string.IsNullOrEmpty(sortProperty))
                this.sortProperty = (propertyDescriptors ?? (propertyDescriptors = TypeDescriptor.GetProperties(typeof(T)))).Find(sortProperty, true);
            this.sortDirection = sortDirection;
        }
        ...
        public string SortProperyName
        {
            ...
            set
            {
                if (string.IsNullOrEmpty(value))
                    sortProperty = null;
                else sortProperty = (propertyDescriptors ?? (propertyDescriptors = TypeDescriptor.GetProperties(typeof(T)))).Find(value, true);

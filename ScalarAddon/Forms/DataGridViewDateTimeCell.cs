...
namespace AstralVars.Forms
{
    public class DataGridViewDateTimeCell : DataGridViewTextBoxCell
    {
            ...
            initialFormattedValue, DataGridViewCellStyle dataGridViewCellStyle)
        {
            ...
            DateTimeCellEditingControl ctl =
                DataGridView.EditingControl as DateTimeCellEditingControl;
        ...
        public override Type EditType
        {
            get
            {
                ...
                return typeof(DateTimeCellEditingControl);
            }
        }
    ...
    class DateTimeCellEditingControl : DateTimePicker, IDataGridViewEditingControl
    {
        DataGridView dataGridView;
        private bool valueChanged = false;
        int rowIndex;

        public DateTimeCellEditingControl()
        {

...
namespace EntityCore.Forms
{
    public partial class EntitySelectForm : XtraForm //*/ Form
    {
        ...
        public static EntityDef Processing(string entPattern, ItemFilterStringType strMatchType = ItemFilterStringType.Simple, EntityNameType nameType = EntityNameType.NameUntranslated)
        {
            if (@this == null)
                @this = new EntitySelectForm();

            @this.Comparer = EntityToPatternComparer.Get(entPattern, strMatchType, nameType);

            @this.FillEntitiesDgv(entPattern);
        ...
        //public static EntityDef Processing(string entityUntrName)
        //{
        //    if (@this == null)
        //        @this = new EntitySelectForm();
        ...
        private void FillEntitiesDgv(string currentEntityId = null)
        {

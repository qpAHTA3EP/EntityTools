...
{
    public static class StaticMethodInvokerMaker
    {
        public static StaticMethodInvoker<ReturnType> GetStaticMethodInvoker<ReturnType>(this Type containerType, string methodName, Type[] argumentTypes, BindingFlags flags = BindingFlags.Default)
        {
            return new StaticMethodInvoker<ReturnType>(containerType, methodName, argumentTypes, flags);
        }

        public static StaticVoidMethodInvoker GetStaticMethodInvoker(this Type containerType, string methodName, Type[] argumentTypes, BindingFlags flags = BindingFlags.Default)
        {

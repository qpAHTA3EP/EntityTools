    ...
    public static class EntitySelectionTools
    {
        ...
        public static Entity FindClosestContactEntity(string entPattern, ItemFilterStringType strMatchType = ItemFilterStringType.Simple, EntityNameType nameType = EntityNameType.NameUntranslated, bool healthCheck = false, float range = 0, bool regionCheck = false, List<string> customRegionNames = null, TempBlackList<uint> bkList = null)
        {
            ...
            foreach (ContactInfo contact in EntityManager.LocalPlayer.Player.InteractInfo.NearbyContacts)
            {
                ...
                {
                    if (bkList != null && bkList.Contains(contact.Entity.ContainerId))//(contact.Entity.Pointer))
                        continue;
        ...
        /// <returns>Найденное Entity</returns>
        private static Entity FindClosestEntityRegexNameInternal(List<Entity> entities, string entPattern, bool healthCheck = false, float range = 0, bool regionCheck = false, List<string> customRegionNames = null, TempBlackList<uint> bkList = null, bool interactable = false)
        {
            Entity closestEntity = new Entity(IntPtr.Zero);
            ...
            if (!string.IsNullOrEmpty(entPattern) && entities != null)
            {
                ...
                foreach (Entity entity in entities)
                {
                    if ((!regionCheck || entity.RegionInternalName == EntityManager.LocalPlayer.RegionInternalName)
                        ...
                        && !bkList.Contains(entity.ContainerId))//(entity.Pointer))
                    {
        ...
        /// <param name="bkList">Список указателей запрещенных Entity</param>
        /// <returns>Найденное Entity</returns>
        private static Entity FindClosestEntityRegexNameUntranslated(List<Entity> entities, string entPattern, bool healthCheck = false, float range = 0, bool regionCheck = false, List<string> customRegionNames = null, TempBlackList<uint> bkList = null, bool interactable = false)
        {
            Entity closestEntity = new Entity(IntPtr.Zero);
        ...
        /// <param name="bkList">Список указателей запрещенных Entity</param>
        /// <returns>Найденное Entity</returns>
        private static Entity FindClosestEntitySimpleNameInternal(List<Entity> entities, string entPattern, bool healthCheck = false, float range = 0, bool regionCheck = false, List<string> customRegionNames = null, TempBlackList<uint> bkList = null, bool interactable = false)
        {
            Entity closestEntity = new Entity(IntPtr.Zero);
            if (!string.IsNullOrEmpty(entPattern) && entities != null)
            {
        ...
        /// <param name="bkList">Список указателей запрещенных Entity</param>
        /// <returns>Найденное Entity</returns>
        private static Entity FindClosestEntitySimpleNameUntranslated(List<Entity> entities, string entPattern, bool healthCheck = false, float range = 0, bool regionCheck = false, List<string> customRegionNames = null, TempBlackList<uint> bkList = null, bool interactable = false)
        {
            Entity closestEntity = new Entity(IntPtr.Zero);
            if (!string.IsNullOrEmpty(entPattern) && entities != null)
            {
        ...
        /// <param name="bkList">Список указателей запрещенных Entity</param>
        /// <returns>Найденное Entity</returns>
        //private static Entity FindClosestInteractableEntityRegex(List<Entity> entities, string entPattern, bool regionCheck = false, TempBlackList<uint> bkList = null)
        //{
        //    Entity closestEntity = new Entity(IntPtr.Zero);
        //    if (!string.IsNullOrEmpty(entPattern) && entities != null)
        //    {
        ...
        /// <param name="bkList">Список указателей запрещенных Entity</param>
        /// <returns>Найденное Entity</returns>
        //public static Entity FindClosestInteractableEntity(List<Entity> entities, string entPattern, ItemFilterStringType type = ItemFilterStringType.Simple, bool regionCheck = false, TempBlackList<uint> bkList = null)
        //{
        //    Entity closestEntity = new Entity(IntPtr.Zero);
        //    if (!string.IsNullOrEmpty(entPattern) && entities != null)
        //    {
        ...
        public static List<Entity> FindAllEntities(List<Entity> entities, string entPattern, ItemFilterStringType strMatchType = ItemFilterStringType.Simple, EntityNameType nameType = EntityNameType.NameUntranslated, 
            bool healthCheck = false, bool regionCheck = false, List<string> customRegionNames = null, TempBlackList<uint> bkList = null)
        {
        ...
        /// <param name="bkList">Список указателей запрещенных Entity</param>
        /// <returns>Список найденных Entity</returns>
        private static List<Entity> FindAllEntitiesSimpleNameUntranslated(List<Entity> entities, string entPattern, bool healthCheck = false, bool regionCheck = false, List<string> customRegionNames = null, TempBlackList<uint> bkList = null)
        {
            List<Entity> resultList = null;
            if (!string.IsNullOrEmpty(entPattern) && entities != null)
            {
                ...
                if (entPattern[0] != '*')
                {
                    ...
                    resultList = entities.FindAll((Entity x) => (x.NameUntranslated.StartsWith(entPattern)
                                                                    ...
                                                                    && !bkList.Contains(x.ContainerId)));//(x.Pointer)));
                }
                else
                {
                    // Поиск любого вхождения шаблона
        ...
        /// <param name="bkList">Список указателей запрещенных Entity</param>
        /// <returns>Список найденных Entity</returns>
        private static List<Entity> FindAllEntitiesSimpleNameInternal(List<Entity> entities, string entPattern, bool healthCheck = false, bool regionCheck = false, List<string> customRegionNames = null, TempBlackList<uint> bkList = null)
        {
            List<Entity> resultList = null;
            if (!string.IsNullOrEmpty(entPattern) && entities != null)
            {
        ...
        /// <param name="bkList">Список указателей запрещенных Entity</param>
        /// <returns>Список найденных Entity</returns>
        private static List<Entity> FindAllEntitiesRegex(List<Entity> entities, string entPattern, EntityNameType nameType = EntityNameType.NameUntranslated, bool healthCheck = false, bool regionCheck = false, List<string> customRegionNames = null, TempBlackList<uint> bkList = null)
        {
            List<Entity> resultList = null;
            if (!string.IsNullOrEmpty(entPattern) && entities != null)
            {

...
namespace EntityPlugin.Conditions
{
    ...
    [Serializable]
    public class NodesCountInCustomRegions : Condition
    {
        [Description("True: Count Nodes located in the listed CustomRegions.\n" +
            "False: Count Nodes located out of the listed CustomRegions")]
        [Category("Location")]
        ...
        [Description("Only the Nodes in this list will be counted. Count all if empty.")]
        [Editor(typeof(PositionNodeListEditorr), typeof(UITypeEditor))]
        [Category("Node")]
        public List<Vector3> WhiteList { get; set; }

        [Description("The Nodes is this list will not be counted.")]
        [Editor(typeof(PositionNodeListEditorr), typeof(UITypeEditor))]
        [Category("Node")]
        ...
        public NodesCountInCustomRegions()
        {
            Value = 0;

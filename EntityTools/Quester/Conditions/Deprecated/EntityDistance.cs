...
namespace EntityTools.Quester.Conditions
{
    ...
    public class EntityDistance : Condition
    {
        ...
        {
            return $"[Deprecated] Entity [{EntityID}] Distance {Sign} to {Distance}";
        }
        ...
        public override string TestInfos
        {
            get
            {
                Entity closestEntity = EntitySelectionTools.FindClosestEntity(EntityManager.GetEntities(), EntityID, EntityIdType, (coreEntityNameType)EntityNameType.NameUntranslated, false, 0, RegionCheck);

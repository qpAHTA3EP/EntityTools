...
namespace EntityTools.Patches.Mapper.Tools
{
    ...
    {
        //TODO Исправить сброс выделенных вершин при их перемещении в новую позицию, если клик ПКМ близок к другой, не выделенной вершине
        ...
        /// </summary>
        public bool AllowNodeSelection =>
#if true
            true;
#else

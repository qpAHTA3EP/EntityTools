...
#if DEBUG && LOG
                            ETLogger.WriteLine(LogType.Debug,
                                $"LinkNearest1: UniLink {{las  -> equivalent}} <{lastND.Node.X:N3};{lastND.Node.Y:N3};{lastND.Node.Z:N3}>");
#endif
                        }
                        else
                        {
...
#if DEBUG && LOG
                            ETLogger.WriteLine(LogType.Debug,
                                $"LinkNearest1: BiLink {{las < -> equivalent}} <{lastND.Node.X:N3};{lastND.Node.Y:N3};{lastND.Node.Z:N3}>");
#endif
                        }
                    }
...
#if DEBUG && LOG
                            ETLogger.WriteLine(LogType.Debug,
                                $"LinkNearest1: Link {{las <->ew}} <{lastND.Node.X:N3};{lastND.Node.Y:N3};{lastND.Node.Z:N3}>");
#endif
                        }
                    }
